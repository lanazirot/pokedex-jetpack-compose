...
object AppModule {
    ...
    @Provides
    @Singleton
    fun providePokemonService(): IPokemonService =
        PokemonService(pokemonRepository = providePokemonRepository())

    @Provides
    @Singleton
    fun providePokemonLocalRepository(): IPokemonLocalRepository =
        PokemonLocalRepository(pokemonRepository = providePokemonRepository())

    @Provides
    @Singleton
    fun provideUserManager(): IUserManager =
        UserManager(pokemonLocalRepository = providePokemonLocalRepository())
    ...
    fun provideAuthService(
        auth: FirebaseAuth, oneTapClient: SignInClient, @Named(SIGN_IN) signInRequest: BeginSignInRequest
